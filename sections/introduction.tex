...
the score equation $\sum_i \T(R_i) = n\,\E[\T]$ at the MLE, a fact known
for coarsened and hidden-data exponential families \citep{domke2020moment},
so is the contribution merely that several papers reused an elementary
...
moral every sibling issues, the coarsened-data instance of the equal-fit
phenomenon of \citet{molenberghs2008every}, and it is the opposite of a
triviality.
